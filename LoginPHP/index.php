...
//loginEjempl
if (!empty($_POST)){
  $usuario1=mysqli_real_escape_string($conexion,$_POST['user']);
    $password2=mysqli_real_escape_string($conexion,$_POST['pass']);
      $sql="SELECT idusuarios FROM usuarios WHERE usuario='$usuario1' AND password='$password2'";
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Mi Tiendita </span>
									<span class="white" id="id-text2">En Linea</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy;Lo mejor para tu vida</h4>
							</div>
